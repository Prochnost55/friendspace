...
Dim i, tempArray
	...
	%>
		...
		<tr>
			<td colspan="2" class="text"><h1>Select the image to upload</h1></td>		
		</tr>
		<tr>
			<td class="text">
				<b>File: </b><input type="file" name="file1" id="btn"/><br/>	
			</td>
		</tr>
		
		<tr>
			<td class="text">
				Example Name : <input name="txtName" type="text" id="input" />
			</td>
		</tr>
