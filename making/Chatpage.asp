...
<%
 Myfile = "C:\data\"& user &"\chat\Chat_"&suser&".txt"
 set MyFileObject = server.CreateObject("Scripting.filesystemobject")
 if MyFileObject.FileExists(Myfile) Then 
%>
  </div>
  <div id="main"><center>Conversation</center></div><hr width="400px" color="#993399">
 ...
 <%
			...
			Set Myfile=Fileobj.openTextFile("C:\data\"& user &"\chat\Chat_"&suser&".txt",1, 8)
