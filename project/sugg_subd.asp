...
<body class="oneColElsCtrHdr">
 <h1>Thank You for Submitting your precios suggetion : </h1>
...
<% 			
			...
			Set Myfile=Fileobj.openTextFile(server.mappath("data")&"\suggestion.txt")
...
<center><Form action="user.asp">
<input type="submit" value="Back to userpage" class="btn">
</Form></center>
<% end if%>
	<!-- end #mainContent --></div>
